...
void STrack::re_activate(STrackPtr& new_track, int frame_id, bool new_id)
{
...
void STrack::update(STrackPtr& new_track, int frame_id)
{
    this->frame_id = frame_id;
    this->tracklet_len++;
...
void STrack::multi_predict(vector<STrackPtr> &stracks, KalmanFilter &kalman_filter)
{
